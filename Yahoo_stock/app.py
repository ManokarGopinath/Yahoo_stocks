...
def gainers():
    ...
    dataframe.to_csv('./static/files/gainers.csv', encoding='utf-8')
    return '200 Status ok'
...
def losers():
    ...
    dataframe.to_csv('./static/files/losers.csv', encoding='utf-8')
    return '200 Status ok'
...
def trendingtickers():
    ...
    dataframe.to_csv('./static/files/trendingtickers.csv', encoding='utf-8')
    return '200 Status ok'
user_agent_nasdaq = [
...
def nasdaqfiles():
    ...
    if request.method == "GET":
        ...
        with open('./static/files/nasdaqfile.csv', 'w', newline='') as f_output:
...
def nasdaqc():
    ...
    if request.method == "GET":
        if True:
            ...
            df.to_csv('./static/files/yahoo_nasdaq_current.csv')
            return 'ok'
...
def nasdaqfuture():
    ...
    if request.method == "GET":
        if True:
            ...
            df = pd.DataFrame(dictionary)
             # saving the dataframe
            df.to_csv('./static/files/yahoo_nasdaq_future.csv')
            return 'ok'
